 ...
 */
class SoundPopView extends egret.Sprite{
    ...
    private initView():void
    {
        ...
        var bg:egret.Bitmap = ResourceUtils.createBitmapByName("option1BgImage");
    ...
    private touchHelp(e:egret.TouchEvent):void
    {
        ...
        var _sheight:number = Const.SCENT_HEIGHT - close_btn.height-20;
        close_btn.x = _swidth;
