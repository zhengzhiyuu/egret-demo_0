    ...
    var Fish = (function (_super) {
        ...
        Fish.prototype.initView = function () {
            ...
            this.addEventListener(egret.Event.ADDED_TO_STAGE, function () {
                ...
                _this.width = 80;
                _this.height = 55;
                _this.x = GameScene.main.width / 2;
                _this.y = GameScene.main.height / 2;
                ...
                _this.fishTail = new egret.MovieClip(mcFactory.generateMovieClipData("Main"));
                _this.addChild(_this.fishTail);
                _this.fishTail.x = _this.width / 2 - 4;
                _this.fishTail.y = _this.height / 2 - _this.fishTail.height / 2;
                _this.fishTail.gotoAndPlay("start", -1);
                ...
                GameScene.main.addEventListener(egret.TouchEvent.TOUCH_MOVE, function (evt) {
                    ...
                    _this.rotation = Utils.getAngle(_this.x, _this.y, mx, my) + 90;
