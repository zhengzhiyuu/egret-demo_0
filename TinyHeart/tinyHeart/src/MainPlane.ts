module TinyHeart {
    ...
    export class GameScene {
        ...
        public constructor() {
            ...
            timer.addEventListener(egret.TimerEvent.TIMER, (): void => {
                this.initFruit();
                count += 1;
                if (count > 9) { this.initBlue(); count = 0; }
            }, this);
            timer.start();
        ...
        private initFruit(): void {
            if (this.anyXY.length !== 0) {
                ...
                timer.addEventListener(egret.TimerEvent.TIMER, (): void => {
                    ...
                    // if (count >= enemyTime * 1000) { this.initBlue(); count = 0; console.log('....')}
    ...
    class Fish extends egret.DisplayObjectContainer {
        ...
        private fishTail: egret.MovieClip;
        ...
        private initView() {
            this.addEventListener(egret.Event.ADDED_TO_STAGE, (): void => {
                ...
                this.width = 80;
                this.height = 55;
                this.x = GameScene.main.width / 2;
                this.y = GameScene.main.height / 2;
                ...
                // this.fishTail.x = this.width / 2 - 4;
                ...
                this.fishTail = new egret.MovieClip(mcFactory.generateMovieClipData("Main"));
                this.addChild(this.fishTail);
                this.fishTail.x = this.width / 2 - 4;
                this.fishTail.y = this.height / 2 - this.fishTail.height / 2;
                this.fishTail.gotoAndPlay("start", -1);
                ...
                GameScene.main.addEventListener(egret.TouchEvent.TOUCH_MOVE, (evt: egret.TouchEvent): void => {
                    ...
                    this.rotation = Utils.getAngle(this.x, this.y, mx, my) + 90;
